 ...
 * 代码解释对话框
 */
class ExplainCodeDialog(private val project: Project, private val selectedCode: String) : DialogWrapper(project) {
    ...
    private fun createSelectionPanel(): JPanel {
        ...
        templatePanel.add(JBLabel("选择解释模板:"), BorderLayout.WEST)
        
        templateComboBox = JComboBox()
        loadExplainTemplates()
    ...
    private fun createCodePanel(): JPanel {
        ...
        // 代码显示
        panel.add(JBLabel("要解释的代码:"), BorderLayout.NORTH)
    ...
    private fun loadExplainTemplates() {
        templateComboBox.removeAllItems()
        val allTemplates = promptTemplateService.getTemplates()
        val templates = allTemplates.filter { 
            it.enabled && (it.category == "代码解释" || it.category == "解释" || it.category == "代码分析" || it.category == "默认")
        }
    ...
    override fun getOKAction(): Action {
        ...
        action.putValue(Action.NAME, "解释")
        return action
    }
}